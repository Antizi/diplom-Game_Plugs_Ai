...
# Корень gamedb_api в PYTHONPATH
ROOT = Path(__file__).resolve().parents[1]
sys.path.insert(0, str(ROOT))

from gamedb_backend.database import SessionLocal, engine  # noqa: E402
from gamedb_backend import models  # noqa: E402
from gamedb_backend.main import _run_migrations  # noqa: E402
